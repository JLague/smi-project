...
void initDMA(void) {
	RCC->AHB1ENR |= (1 << 21);
	// CHSEL=7, MBURST=0, PBURST=0, CT=don't_care, DBM=0, PL=3, PINCOS=0, MSIZE=1, PSIZE=0, MINC=1, PINC=0, CIRC=1, DIR=1, PFCTRL=0, TCIE=don't_care, HTIE=don't_care, TEIT=don't_care, DMEIE=don't_care
